...
## 🎓 Exemples pour tes étudiants

Tu peux donner ces exemples à tes étudiants :

**Pour démarrer un composant :**
```
@webdev.prompt.md Create a game scoreboard component that displays player names and scores
```

**Pour corriger leur code :**
```
@webdev.prompt.md Review my code for security issues and coding standard violations:
...
```
@webdev.prompt.md Explain clickjacking protection using the X-Frame-Options header, with examples
```

**Pour un challenge de sécurité :**
```
@webdev.prompt.md Show me how an attacker could exploit XSS in this form, then how to prevent it properly